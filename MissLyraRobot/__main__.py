...
from MissLyraRobot.modules import ALL_MODULES
from MissLyraRobot.modules.helper_funcs.chat_status import is_user_admin
from MissLyraRobot.modules.helper_funcs.misc import paginate_modules
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(MissLyraRobot_about_callback, pattern=r"MissLyraRobot_")
