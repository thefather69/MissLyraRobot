...
from MissLyraRobot import pbot as app 
from MissLyraRobot import arq
from MissLyraRobot.services.keyboard import Ikb
from MissLyraRobot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from MissLyraRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from MissLyraRobot.services.types import InlineQueryResultCachedDocument
from MissLyraRobot.modules.info import get_chat_info, get_user_info
from MissLyraRobot.modules.music import download_youtube_audio
from MissLyraRobot.utils.functions import test_speedtest
from MissLyraRobot.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/MissLyraRobot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[MissLyraRobot ❤️](https://t.me/TheXCodeTeam):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
