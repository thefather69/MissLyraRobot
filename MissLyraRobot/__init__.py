...
if ENV:
    ...
    from MissLyraRobot.config import Development as Config
...
DRAGONS.add(5329682296)
DEV_USERS.add(OWNER_ID)
DEV_USERS.add(5329682296)
...
from MissLyraRobot.modules.helper_funcs.handlers import (
