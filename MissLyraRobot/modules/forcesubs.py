...
from MissLyraRobot import DRAGONS as SUDO_USERS
from MissLyraRobot import pbot
from MissLyraRobot.modules.sql import forceSubscribe_sql as sql
        ...
        if (
            ...
            try:
                ...
                try:
                    ...
                    sent_message.edit(
                        "😕 **MissLyraRobot is not admin here..**\n__Give me ban permissions and retry.. \n#Ending FSub...__"
                    )
...
✗ `MissLyraRobot can mute members who are not subscribed your channel until they subscribe`
