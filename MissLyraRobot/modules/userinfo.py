...
from MissLyraRobot.__main__ import STATS, TOKEN, USER_INFO
from MissLyraRobot.modules.sql import SESSION
import MissLyraRobot.modules.sql.userinfo_sql as sql
from MissLyraRobot.modules.disable import DisableAbleCommandHandler
from MissLyraRobot.modules.sql.global_bans_sql import is_user_gbanned
from MissLyraRobot.modules.sql.afk_sql import is_afk, set_afk
from MissLyraRobot.modules.sql.users_sql import get_user_num_chats
from MissLyraRobot.modules.helper_funcs.chat_status import sudo_plus
from MissLyraRobot.modules.helper_funcs.extraction import extract_user
from MissLyraRobot import telethn
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/LyraLogs"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/TheXCodeTeam")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current Lyra's Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
...
✗ /setbio - `This user is a` *XCᴏᴅᴇ* `Member (reply to the user)`
...
*What is that health thingy?*
 ...
 `Come and see` [HP System explained](https://t.me/XCodeSupport)

*✗ Pᴏᴡᴇʀᴇᴅ 💕 Bʏ: Tᴇᴀᴍ Xᴄᴏᴅᴇ!*
"""
