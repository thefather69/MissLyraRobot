...
from MissLyraRobot import ALLOW_EXCL, CustomCommandHandler, dispatcher
...
from MissLyraRobot.modules.sql import cleaner_sql as sql
...
✗ /gignoreblue - `<word> globally ignorea bluetext cleaning of saved word across Tᴇᴀᴍ Xᴄᴏᴅᴇ.`
